...
from keras.layers import Activation,Flatten,merge,Input,Multiply,Convolution1D,Dense, K,Layer, Embedding,Dropout,Bidirectional, MaxPooling1D,AveragePooling1D,LSTM
...
emb=Embedding(len(word_index)+1, 300, input_shape=(maxlen,),trainable=True,weights=[embedding_matrix])(input)
pool=AveragePooling1D(pool_size=2)(emb)
dropout1=Dropout(0.5)(pool)
dense=Dense(300,activation="relu")(dropout1)
dropout2=Dropout(0.5)(dense)
concat=merge([dropout2,emb],mode="concat",concat_axis=1)

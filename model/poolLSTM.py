...
from keras.layers import Flatten,Activation,Multiply,Convolution1D,GRU,Dense, K,Layer, Embedding,Dropout,Bidirectional, MaxPooling1D,AveragePooling1D,LSTM

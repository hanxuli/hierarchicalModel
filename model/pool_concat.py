...
from keras.layers import Input,merge,Activation,Multiply,Convolution1D,Dense, K,Layer, Embedding,Dropout,Bidirectional, MaxPooling1D,AveragePooling1D,LSTM
...
average=AveragePooling1D()(embed)
max_pool=MaxPooling1D()(embed)
concat=merge([average,max_pool],mode="concat",concat_axis=1)
dropout=Dropout(0.5)(concat)
bilstm=Bidirectional(LSTM(128,return_sequences=True))(dropout)
attention=Attention()(bilstm)
dr=Dropout(0.5)(attention)
dense=Dense(num_classes,activation='softmax')(dr)

...
from keras.layers import AveragePooling1D,MaxPooling1D,LSTM,LeakyReLU,K,Layer,TimeDistributed, Multiply,Permute,Dense, Embedding,Dropout,Activation,Bidirectional,Convolution1D, MaxPooling1D, Flatten
...
#训练数据预处理
x_train,y_train=predataset("../data/yelp13/train.txt")
...
#测试数据预处理
x_test,y_test=predataset("../data/yelp13/test.txt")
# 分词并对句子进行序列映射
...
#测试数据预处理
x_val,y_val=predataset("../data/yelp13/dev.txt")
# 分词并对句子进行序列映射
